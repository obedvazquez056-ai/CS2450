...
Date: 11/14/2025
This week we learned how to deploy our project for other people to use. I found it really interesting as I never really thought about this concept. Thinking back it doesn't make sense for people to have to pull or download all our files and packages that we used to be able to run our app. Using docker they are able download the app and run it with out having to download everything we used.      
